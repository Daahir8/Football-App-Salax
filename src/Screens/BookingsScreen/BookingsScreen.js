...
},
{
  ...
  <Text style={{alignSelf :"center",fontSize :22,fontWeight :"500",color :"black"}} >Bookings </Text>
</View>
...
<ImageBackground source={{uri :"https://c8.alamy.com/comp/2J26JWT/vertical-shot-of-a-soccer-ball-on-football-field-2J26JWT.jpg",alignItems :"center",justifyContent :"center"}} style={{width :"100%",height:390,marginTop :10,borderRadius :20,alignItems :"center",justifyContent :"center"}} imageStyle={{borderRadius :20}} >
<View style={{width :"100%",height :"100%",backgroundColor :"rgba(0,0,0,0.3)",alignItems :"center",justifyContent :"center",borderRadius :20}} >
<View style={{width :"100%",height :60 ,backgroundColor :"red",alignItems :"center",justifyContent :"center"}} >
<Text style={{color :'white', fontSize :14,fontWeight :"400"}} >STATUS</Text>
  
<Text style={{color :'white', fontSize :24,fontWeight :"bold"}} >BOOKED</Text>
{/* <View style={{flexDirection :"row",alignItems :"center",justifyContent :"center",marginTop :5}} >
<Image source={{uri : "https://sb.kaleidousercontent.com/67418/1920x1545/c5f15ac173/samuel-raita-ridxdghg7pw-unsplash.jpg"}} style={{width :30,height :30,borderRadius :30,borderWidth :3,borderColor :"white"}} />
<Image source={{uri : "https://sb.kaleidousercontent.com/67418/1920x1545/c5f15ac173/samuel-raita-ridxdghg7pw-unsplash.jpg"}} style={{width :30,height :30,borderRadius :30,borderWidth :3,borderColor :"white"}} />

</View> */}
</View>
<TouchableOpacity style={{position: "absolute",bottom: 0,width :'90%' ,height :40,alignItems :"center",justifyContent :"center",backgroundColor :"#04764E",marginBottom :20,borderRadius :10}} >
<Text style={{color :'white', fontSize :14,fontWeight :"bold"}} >Cancel Booking</Text>
