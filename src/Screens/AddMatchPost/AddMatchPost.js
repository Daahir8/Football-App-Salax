import {View, Text, TouchableOpacity, TextInput, Image, FlatList, ScrollView,Dimensions} from 'react-native';
...
<View style={{marginStart :16,justifyContent:"space-between",width :'65%'
}} >
<Text style={{color: '#202226', fontSize: 14,marginTop :10}}>Post Tittle</Text>
<TextInput placeholder='Lets Match' placeholderTextColor={'#838383'} style={{width :"100%",paddingBottom :10,borderBottomWidth :0.5,borderColor :"grey",marginBottom :8}} />
</View>
        </View>
        <View style={{width :"100%",marginTop :30}} >
            <Text style={{fontWeight :"500" ,color :"#202226",fontSize :12}} >Description </Text>
            <View style={{width :"100%",height :80 ,borderBottomWidth :0.5 ,borderColor :"grey"}}  >
            <TextInput style={{marginTop :10}} placeholder='Description.....' placeholderTextColor={'#838383'} />

            </View>
        </View>
        <View style={{width :"100%",marginTop :30}} >
            <Text style={{fontWeight :"500" ,color :"#202226",fontSize :12}} >Organizer Name</Text>
            <TextInput placeholder='Cameron Williamson' placeholderTextColor={'#838383'} style={{width :"100%",height :52 ,borderBottomWidth :0.5 ,borderColor :"grey"}} />
        </View>
        <View style={{width :"100%",marginTop :30}} >
            <Text style={{fontWeight :"500" ,color :"#202226",fontSize :12}} >Ground Name Address</Text>
            <TextInput placeholder='Address : 6391 Elgin St. Celina, Delaware 10299' placeholderTextColor={'#838383'} style={{width :"100%",height :52 ,borderBottomWidth :0.5 ,borderColor :"grey"}} />
        </View>
        <View style={{flexDirection:"row",width :"100%",alignItems :"center",marginTop :30}} >
        <View style={{width :"45%"}} >
            <Text style={{fontWeight :"500" ,color :"#202226",fontSize :12}} >Match Date</Text>
            <TextInput placeholder='3/5/2024' placeholderTextColor={'#838383'} style={{width :"100%",height :52 ,borderBottomWidth :0.5 ,borderColor :"grey"}} />
        </View>
        <View style={{width :"45%",marginStart :20}} >
            <Text style={{fontWeight :"500" ,color :"#202226",fontSize :12}} >Number of Players</Text>
            <TextInput placeholder='22' placeholderTextColor={'#838383'} style={{width :"100%",height :52 ,borderBottomWidth :0.5 ,borderColor :"grey"}} />
        </View>
        </View>
        <View style={{flexDirection:"row",width :"100%",alignItems :"center",marginTop :20}} >
        <View style={{width :"45%"}} >
            <Text style={{fontWeight :"500" ,color :"#202226",fontSize :12}} >Match Timing</Text>
            <TextInput placeholder='7:00 PM' placeholderTextColor={'#838383'} style={{width :"100%",height :52 ,borderBottomWidth :0.5 ,borderColor :"grey"}} />
        </View>
        <View style={{width :"45%",marginStart :20}} >
            <Text style={{fontWeight :"500" ,color :"#202226",fontSize :12}} >Match Price Per Team</Text>
            <TextInput  placeholder='$' placeholderTextColor={'#838383'} style={{width :"100%",height :52 ,borderBottomWidth :0.5 ,borderColor :"grey"}} />
        </View>
        </View>
      </View>
      <View style={{  flexDirection :"row",alignItems :"center",marginStart :15, marginTop :30}} >

<Text style={{fontWeight :'700',fontSize :18,marginStart :5,color :"#04764E"}} >Select Your Lineup</Text>
</View>
      <View style={{width :"100%",backgroundColor :"white",marginTop : 20,justifyContent :"center",height :"auto"}} >
...
style={{justifyContent :"center",marginHorizontal :15,alignItems :"center",marginVertical :10,alignSelf :"center",}} >
...
<Modalize
   ...
   <Text
        ...
        return(
            <View style={{flexDirection :"row",alignItems :"center",width :"100%",alignSelf :"center",height :60,marginTop :10,justifyContent:"space-between"}} >
...
<Text style={{fontSize :14 ,fontWeight :"600" ,color: "#334155"}} >Devone lane</Text>
<Text numberOfLines={1} style={{fontSize :14 ,fontWeight :"300" ,color: "#334155",marginTop :5}} >Get Ready for The Match!.</Text>

</View>
</View>
<View style={{alignItems:"center",flexDirection :"row"}} >
<TouchableOpacity style={{width :36 ,height :36 ,backgroundColor: "#D9EFE7",alignItems :"center",justifyContent :"center",borderRadius :30}} >
                <MaterialIcons name='message' size={22} color='#04764E' />
            </TouchableOpacity>
            <TouchableOpacity style={{marginStart 
              :10
            }} >
