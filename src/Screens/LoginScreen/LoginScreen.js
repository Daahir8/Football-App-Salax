  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View style={{width: '90%', alignSelf: 'center', marginTop: 60}}>
        ...
        <View
          style={{flexDirection: 'row', alignItems: 'center', width: '100%',marginTop :12,justifyContent :"space-between"}}>
            <View style={{flexDirection :"row",alignItems :"center"}} >

          <TouchableOpacity onPress={()=>{
      
            setCheck(prev=> !prev)
          }} style={{marginStart :5,marginEnd: 5,width :16,height :16 ,borderWidth : check ?0: 0.5 ,borderColor :check ?null:"grey",alignItems :"center",justifyContent :"center",borderRadius :2,backgroundColor :check ? "#04764E" :"white"}}>
            {check &&
<Ionicons name='checkmark-sharp' size={14} color='white' />
          ...
          <Text style={{fontSize: 12,marginStart :3,fontWeight :"300"}} >Remember Password</Text>
          </View>
          <TouchableOpacity onPress={()=>{
                navigation.navigate('ForgotPassword')
          }} >
       <Text style={{fontSize :12 ,fontWeight :"400", color:'grey'}} >Forgot password?</Text>
          </TouchableOpacity>
       ...
       <Text style={{fontSize :12 ,fontWeight :"400", color:'grey'}} >Dont have an acccount?</Text>
        <TouchableOpacity onPress={()=>{
          navigation.navigate("Signup")
        }} style={{marginStart :2}} >
        <Text style={{fontSize :12 ,fontWeight :"bold", color:'#04764E'}} >Register</Text>
          </TouchableOpacity>    
          </View>
        </View>
      </View>
