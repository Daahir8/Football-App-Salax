  ...
  const [selectedMode, setSelectedMode] = useState('Draw');
    ...
    },
    {
      ...
      return (
       ...
       <ScrollView contentContainerStyle={{paddingBottom :"10%"}} style={{flex : 1 , backgroundColor : 'white'}} >
   ...
   <Text style={{fontWeight :'500',fontSize :18,marginStart :5,color :"#04764E"}} >Your Lineup</Text>
   </View>
   
   <View style={{width :"100%",backgroundColor :"white",marginTop : 20,justifyContent :"center",height :"auto",marginBottom :'2%'}} >
   ...
   <TouchableOpacity  style={{justifyContent :"center",marginHorizontal :15,alignItems :"center",marginVertical :10,alignSelf :"center",}} >
     ...
     <View
          ...
          <Text style={{fontWeight: '600', fontSize: 16, marginStart: 5}}>
            Select Team Who Won
          </Text>
        </View>
         <FlatList
          ...
          renderItem={({item}) => {
            return (
             ...
             <Text style={{color :selectedMode == item.name ? '#04764E' : "grey" ,marginStart :16,fontSize :16,fontWeight :selectedMode == item.name ? 'bold' : "300" }} >{item.name}</Text>
                <TouchableOpacity
                  onPress={() => {
                    setSelectedMode(item.name);
                  }}
   ...
   <Text style={{fontWeight :'bold',fontSize :24,marginBottom :20}} >Total </Text>
   
   <Text style={{fontWeight :'bold',fontSize :24,marginBottom :20,color :"#04764E"}} >$19.99 </Text>
   
   </View>
   <View style={{width :"100%",alignSelf :"center",flexDirection :"row",justifyContent :"space-between",alignItems :"center",}} >
   <Text style={{fontWeight :'bold',fontSize :24,marginBottom :20}} >Days Remaining </Text>
   
   <Text style={{fontWeight :'bold',fontSize :24,marginBottom :20,color :"#04764E"}} >5 days</Text>
